...
public class MySubmitButton extends View {
    ...
    public MySubmitButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySubmitButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SubmitButton, defStyleAttr, 0);
        if (typedArray.getString(R.styleable.SubmitButton_content) != null) {
            buttonText = typedArray.getString(R.styleable.SubmitButton_content);
        }
        buttonColor = typedArray.getColor(R.styleable.SubmitButton_bg_color, Color.parseColor("#313131"));
        successColor = typedArray.getColor(R.styleable.SubmitButton_success_color, Color.parseColor("#19CC95"));
        failedColor = typedArray.getColor(R.styleable.SubmitButton_failed_color, Color.parseColor("#FC8E34"));
        textSize = (int) typedArray.getDimension(R.styleable.SubmitButton_text_size, sp2px(15));
        contentColor = typedArray.getColor(R.styleable.SubmitButton_content_color, Color.parseColor("#ffffff"));
...
//        bgPaint.setStrokeWidth(5);
    ...
    private void drawButton(Canvas canvas) {
        if(viewState == STATE_LOADING){
            ...
            buttonPath.reset();
            circleLeft.set(-mWidth , -mHeight , -mWidth  + mHeight, mHeight );
            buttonPath.arcTo(circleLeft, 90, 180);
            buttonPath.lineTo(mWidth  - mHeight , -mHeight );
            circleRight.set(mWidth  - mHeight, -mHeight , mWidth , mHeight );
            buttonPath.arcTo(circleRight, 270, 180);
            buttonPath.lineTo(-mWidth  + mHeight , mHeight );
            canvas.drawPath(buttonPath, bgPaint);
            canvas.drawPath(buttonPath, bgPaint);
